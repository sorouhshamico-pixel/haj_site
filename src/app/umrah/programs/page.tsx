  ...
  return (
    <main id="main-content">
      <section className="relative overflow-hidden py-24 text-white lg:py-32">
        ...
        <GeometricPattern id="umrah-programs-geo" className="pointer-events-none absolute inset-0 h-full w-full text-white/[0.06]" />
        ...
        <div className="container-shell relative">
          <Reveal className="mx-auto max-w-2xl text-center">
            ...
            <h1 className="mt-5 text-4xl font-semibold leading-[1.3] sm:text-5xl">برامج العمرة</h1>
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-white/80">
              نقدم أكثر من فئة لبرامج العمرة تناسب احتياجات وميزانيات مختلفة. تواصل معنا لمعرفة المواعيد والأسعار والتفاصيل الكاملة.
            </p>
          </Reveal>
        </div>
      </section>
